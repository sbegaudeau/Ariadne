...
/**
 * Utility class used to internationalize the text of the user interface.
 * 
 * @author <a href="mailto:stephane.begaudeau@obeo.fr">Stephane Begaudeau</a>
 * @since 1.0
 */
public final class AriadneUIMessages {
	/** Qualified path to the properties file in which to seek the keys. */
	private static final String BUNDLE_NAME = "fr.obeo.ariadne.ide.connector.ui.internal.utils.ariadneuimessages"; //$NON-NLS-1$
