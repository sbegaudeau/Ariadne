 ...
 *******************************************************************************/
package fr.obeo.ariadne.ide.connector.core.internal.utils;
...
/**
 * Utility class used to internationalize messages.
 * 
 * @author <a href="mailto:stephane.begaudeau@obeo.fr">Stephane Begaudeau</a>
 * @since 1.0
 */
public final class AriadneCoreMessages {
	/** Qualified path to the properties file in which to seek the keys. */
	private static final String BUNDLE_NAME = "fr.obeo.ariadne.ide.connector.core.internal.utils.ariadnecoremessages"; //$NON-NLS-1$
