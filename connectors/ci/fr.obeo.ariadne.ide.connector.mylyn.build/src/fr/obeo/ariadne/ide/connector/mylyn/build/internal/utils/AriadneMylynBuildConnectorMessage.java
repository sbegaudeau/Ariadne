 ...
 *******************************************************************************/
package fr.obeo.ariadne.ide.connector.mylyn.build.internal.utils;
...
/**
 * Utility class used for the internationalization of the messages of the Mylyn Build connector.
 * 
 * @author <a href="mailto:stephane.begaudeau@obeo.fr">Stephane Begaudeau</a>
 * @since 1.0
 */
public final class AriadneMylynBuildConnectorMessage {
	/** Qualified path to the properties file in which to seek the keys. */
	private static final String BUNDLE_NAME = "fr.obeo.ariadne.ide.connector.mylyn.build.internal.utils.ariadnemylynbuildmessages"; //$NON-NLS-1$
	 ...
	 */
	private AriadneMylynBuildConnectorMessage() {
