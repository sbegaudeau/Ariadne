 ...
 *******************************************************************************/
package fr.obeo.ariadne.ide.connector.pde.internal.utils;
...
/**
 * Utility class used for the internationalization of the messages of the PDE connector.
 * 
 * @author <a href="mailto:stephane.begaudeau@obeo.fr">Stephane Begaudeau</a>
 * @since 1.0
 */
public final class AriadnePDEConnectorMessage {
	/** Qualified path to the properties file in which to seek the keys. */
	private static final String BUNDLE_NAME = "fr.obeo.ariadne.ide.connector.pde.internal.utils.ariadnepdemessages"; //$NON-NLS-1$
	 ...
	 */
	private AriadnePDEConnectorMessage() {
