...
/**
 * Utility class used for the internationalization of the messages of the Java connector.
 * 
 * @author <a href="mailto:stephane.begaudeau@obeo.fr">Stephane Begaudeau</a>
 * @since 1.0
 */
public final class AriadneJavaConnectorMessage {
	/** Qualified path to the properties file in which to seek the keys. */
	private static final String BUNDLE_NAME = "fr.obeo.ariadne.ide.connector.java.internal.utils.ariadnejavamessages"; //$NON-NLS-1$
	 ...
	 */
	private AriadneJavaConnectorMessage() {
