...
/**
 * This is the item provider adapter for a {@link fr.obeo.ariadne.model.scm.Repository} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ScmPackage.Literals.REPOSITORY__NAME,
         true,
         false,
         false,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(ScmPackage.Literals.REPOSITORY__BRANCHES);
      childrenFeatures.add(ScmPackage.Literals.REPOSITORY__COMMITS);
      childrenFeatures.add(ScmPackage.Literals.REPOSITORY__TAGS);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (ScmPackage.Literals.REPOSITORY__BRANCHES,
         ScmFactory.eINSTANCE.createBranch()));

    newChildDescriptors.add
      (createChildParameter
        (ScmPackage.Literals.REPOSITORY__COMMITS,
         ScmFactory.eINSTANCE.createCommit()));

    newChildDescriptors.add
      (createChildParameter
        (ScmPackage.Literals.REPOSITORY__TAGS,
         ScmFactory.eINSTANCE.createTag()));
  }
