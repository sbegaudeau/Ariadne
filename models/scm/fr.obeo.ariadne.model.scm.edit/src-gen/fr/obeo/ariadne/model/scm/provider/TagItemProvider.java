...
/**
 * This is the item provider adapter for a {@link fr.obeo.ariadne.model.scm.Tag} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
  ...
  protected void addCommitPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Tag_commit_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Tag_commit_feature", "_UI_Tag_type"),
         ScmPackage.Literals.TAG__COMMIT,
         true,
         false,
         true,
         null,
