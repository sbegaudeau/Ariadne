...
/**
 * This is the item provider adapter for a {@link fr.obeo.ariadne.model.core.Property} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         CorePackage.Literals.PROPERTY__DESCRIPTION,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  protected void addIdentifierPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Property_identifier_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Property_identifier_feature", "_UI_Property_type"),
         CorePackage.Literals.PROPERTY__IDENTIFIER,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  protected void addExtendedPropertiesPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Property_extendedProperties_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Property_extendedProperties_feature", "_UI_Property_type"),
         CorePackage.Literals.PROPERTY__EXTENDED_PROPERTIES,
         true,
         false,
         true,
         null,
