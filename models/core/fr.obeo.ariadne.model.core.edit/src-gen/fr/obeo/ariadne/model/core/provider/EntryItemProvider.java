...
/**
 * This is the item provider adapter for a {@link fr.obeo.ariadne.model.core.Entry} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         CorePackage.Literals.ENTRY__KEY,
         true,
         false,
         false,
  ...
  protected void addValuesPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Entry_values_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Entry_values_feature", "_UI_Entry_type"),
         CorePackage.Literals.ENTRY__VALUES,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
