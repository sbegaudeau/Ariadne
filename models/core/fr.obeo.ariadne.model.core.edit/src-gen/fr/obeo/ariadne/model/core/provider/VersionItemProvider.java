...
/**
 * This is the item provider adapter for a {@link fr.obeo.ariadne.model.core.Version} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         getString("_UI_PropertyDescriptor_description", "_UI_Version_major_feature", "_UI_Version_type"),
         CorePackage.Literals.VERSION__MAJOR,
         true,
         false,
         false,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         getString("_UI_PropertyDescriptor_description", "_UI_Version_minor_feature", "_UI_Version_type"),
         CorePackage.Literals.VERSION__MINOR,
         true,
         false,
         false,
         ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
  ...
  protected void addPatchPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Version_patch_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Version_patch_feature", "_UI_Version_type"),
         CorePackage.Literals.VERSION__PATCH,
         true,
         false,
         false,
         ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
