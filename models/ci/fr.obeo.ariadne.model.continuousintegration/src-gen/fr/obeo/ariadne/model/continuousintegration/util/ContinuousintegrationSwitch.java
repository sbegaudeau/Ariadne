 ...
 * @generated
 */
public class ContinuousintegrationSwitch<T> extends Switch<T>
{
  /**
   ...
   * @generated
   */
  public ContinuousintegrationSwitch()
  {
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      case ContinuousintegrationPackage.BUILD_SERVER:
      {
      ...
      case ContinuousintegrationPackage.BUILD_JOB:
      {
      ...
      case ContinuousintegrationPackage.PROMOTION_LOCATION:
      {
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Build Server</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Build Server</em>'.
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Build Job</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Build Job</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseBuildJob(BuildJob object)
  {
    return null;
  }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Promotion Location</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Promotion Location</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
