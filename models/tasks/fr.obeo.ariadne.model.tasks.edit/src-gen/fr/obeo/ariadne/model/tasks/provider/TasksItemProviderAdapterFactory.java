...
import fr.obeo.ariadne.model.tasks.util.TasksAdapterFactory;
...
public class TasksItemProviderAdapterFactory extends TasksAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable
{
  ...
  /**
   * This keeps track of the one adapter used for all {@link fr.obeo.ariadne.model.tasks.TasksRepository} instances.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  protected TasksRepositoryItemProvider tasksRepositoryItemProvider;

  /**
   * This creates an adapter for a {@link fr.obeo.ariadne.model.tasks.TasksRepository}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  {
    if (tasksRepositoryItemProvider == null)
    {
      tasksRepositoryItemProvider = new TasksRepositoryItemProvider(this);
    }

    return tasksRepositoryItemProvider;
  }

  /**
   * This keeps track of the one adapter used for all {@link fr.obeo.ariadne.model.tasks.Task} instances.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * This creates an adapter for a {@link fr.obeo.ariadne.model.tasks.Task}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
