 ...
 *   <li>{@link fr.obeo.ariadne.model.code.Operation#getTypingDependency <em>Typing Dependency</em>}</li>
 *   <li>{@link fr.obeo.ariadne.model.code.Operation#getInheritanceDependency <em>Inheritance Dependency</em>}</li>
...
public interface Operation extends VersionedElement
{
   ...
   * @see fr.obeo.ariadne.model.code.CodePackage#getOperation_TypingDependency()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.obeo.ariadne.model.code.Operation#getTypingDependency <em>Typing Dependency</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.obeo.ariadne.model.code.CodePackage#getOperation_InheritanceDependency()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.obeo.ariadne.model.code.Operation#getInheritanceDependency <em>Inheritance Dependency</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
