...
/**
 * This is the item provider adapter for a {@link fr.obeo.ariadne.model.code.Component} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Component_identifier_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Component_identifier_feature", "_UI_Component_type"),
         CodePackage.Literals.COMPONENT__IDENTIFIER,
         true,
         false,
         false,
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (CodePackage.Literals.COMPONENT__CLASSPATH_ENTRIES,
         CodeFactory.eINSTANCE.createClasspathEntry()));

    newChildDescriptors.add
      (createChildParameter
        (CodePackage.Literals.COMPONENT__RESOURCES_CONTAINERS,
