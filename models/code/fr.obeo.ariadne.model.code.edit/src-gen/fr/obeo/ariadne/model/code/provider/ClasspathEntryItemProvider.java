...
/**
 * This is the item provider adapter for a {@link fr.obeo.ariadne.model.code.ClasspathEntry} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_ClasspathEntry_kind_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_ClasspathEntry_kind_feature", "_UI_ClasspathEntry_type"),
         CodePackage.Literals.CLASSPATH_ENTRY__KIND,
         true,
         false,
         false,
  ...
  /**
   * This adds a property descriptor for the Input Folder feature.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  protected void addInputFolderPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_ClasspathEntry_inputFolder_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_ClasspathEntry_inputFolder_feature", "_UI_ClasspathEntry_type"),
         CodePackage.Literals.CLASSPATH_ENTRY__INPUT_FOLDER,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  protected void addOutputFolderPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_ClasspathEntry_outputFolder_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_ClasspathEntry_outputFolder_feature", "_UI_ClasspathEntry_type"),
         CodePackage.Literals.CLASSPATH_ENTRY__OUTPUT_FOLDER,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(CodePackage.Literals.CLASSPATH_ENTRY__TYPES_CONTAINERS);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (CodePackage.Literals.CLASSPATH_ENTRY__TYPES_CONTAINERS,
         CodeFactory.eINSTANCE.createTypesContainer()));
  }
