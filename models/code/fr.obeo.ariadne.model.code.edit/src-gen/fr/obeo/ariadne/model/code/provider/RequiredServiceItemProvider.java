...
/**
 * This is the item provider adapter for a {@link fr.obeo.ariadne.model.code.RequiredService} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_RequiredService_identifier_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_RequiredService_identifier_feature", "_UI_RequiredService_type"),
         CodePackage.Literals.REQUIRED_SERVICE__IDENTIFIER,
         true,
         false,
         false,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(CodePackage.Literals.REQUIRED_SERVICE__TYPING_DEPENDENCIES);
      childrenFeatures.add(CodePackage.Literals.REQUIRED_SERVICE__REFERENCE_DEPENDENCIES);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (CodePackage.Literals.REQUIRED_SERVICE__TYPING_DEPENDENCIES,
         CodeFactory.eINSTANCE.createTypingDependency()));

    newChildDescriptors.add
      (createChildParameter
        (CodePackage.Literals.REQUIRED_SERVICE__REFERENCE_DEPENDENCIES,
